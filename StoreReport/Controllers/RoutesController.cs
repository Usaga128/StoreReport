...
namespace StoreReport.Controllers
{
    public class RoutesController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("RouteID,RouteName,UserName,CreatedDate")] Route route)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("RouteID,RouteName,UserName,CreatedDate")] Route route)
        {
            if (id != route.RouteID)
            {
                return NotFound();
